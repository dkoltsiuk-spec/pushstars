...
- Project ID: push-stars-d620e
- Номер проекта Google Cloud: 341595072875
- Blaze включён, budget alert настроен
- iOS bundle ID: [com.pushstars.app](http://com.pushstars.app)
- Android package name: [com.pushstars.app](http://com.pushstars.app)
...
- PUN2 App ID: b09ed51f-b53c-41a0-a2a2-d23f2cbbd2ec
- Регион по умолчанию: All
