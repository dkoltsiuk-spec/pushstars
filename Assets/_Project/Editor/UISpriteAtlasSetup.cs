...
namespace PushStars.Editor
{
    ...
    /// 2048-px background would just fill the atlas; it's better standalone.
    ///
    ...
    public static class UISpriteAtlasSetup
    {
        ...
        public static void Run()
        {
            ...
            // Collect every UI sprite except the full-screen background.
            ...
            EditorUtility.DisplayDialog(
                ...
                "This cuts UI draw calls (better FPS on mobile). The full-screen BG.png is " +
                "intentionally left out.\n\nSprite references in prefabs/scenes are unchanged — " +
                "Unity redirects them to the atlas at runtime.",
                "OK");
        }
    }
}
